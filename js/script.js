var Thumbnail = document.getElementById("URL da Thumbnail").value;
var Video = document.getElementById("URL do Video").value;
var Legenda = document.getElementById("URL da legenda").value;

    if(Legenda == ''){
        document.getElementById("VID").innerHTML = '<form class="video-container" action="" method="GET"><video preload="none" class="jlplayer-video" poster="' + Thumbnail + '"><source src="' + Video + '" type="video/mp4"></video></form>';
     }else{
        document.getElementById("VID").innerHTML = '<form class="video-container" action="" method="GET"><video preload="none" class="jlplayer-video" poster="' + Thumbnail + '"><source src="' + Video + '" type="video/mp4"><track kind="captions" src="' + Legenda + '" default></video></form>';
    }
